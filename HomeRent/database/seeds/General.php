    ...
    public function run()
    {
        ...
        DB::table('core_settings')->insert(
            [
                [
                    'name' => "email_header",
                    'val' => '<h1 class="site-title" style="text-align: center">Booking</h1>',
                    'group' => "general",
                ],
                [
                    'name' => "email_footer",
                    'val' => '<p class="" style="text-align: center">&copy; 2019 Booking. All rights reserved</p>',
                    'group' => "general",
                ],
            ]
        );
