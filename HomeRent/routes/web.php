...
Route::group(['prefix'=>'user','middleware' => ['auth']],function(){
    ...
    Route::match(['get','post'],'/apartment','\Modules\User\Controllers\ManageTourController@manageTour');
    Route::match(['get','post'],'/apartment/create','\Modules\User\Controllers\ManageTourController@createTour');
    Route::match(['get','post'],'/apartment/edit/{slug}','\Modules\User\Controllers\ManageTourController@editTour');
    Route::match(['get','post'],'/apartment/del/{slug}','\Modules\User\Controllers\ManageTourController@deleteTour');
});
