<form class="form bravo-form-register" method="post">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-12">
            <div class="form-group">
                <input type="text" class="form-control" name="first_name" autocomplete="off" placeholder="{{__("Имя")}}">
        ...
        <div class="col-lg-6 col-md-12">
            <div class="form-group">
                <input type="text" class="form-control" name="last_name" autocomplete="off" placeholder="{{__("Фамилия")}}">
                <i class="input-icon field-icon fa"><img src="{{url('images/ico_fullname_signup.svg')}}"></i>
    ...
    <div class="form-group">
        <label for="term">
            ...
            {{__("Регистрируясь, я принимаю Политику конфиденциальности и Условия предоставления услуг.")}}
    ...
    <div class="c-grey f14 text-center">
       {{__(" Уже есть учетная запись?")}}
        <a href="#" data-target="#login" data-toggle="modal">{{__("Войти в систему")}}</a>
    </div>
</form>