                ...
                <div class="col-md-9">
                    <div class="user-form-settings">
                        ...
                        <h2 class="title-bar no-border-bottom">
                            {{$row->id ? 'Edit: '.$row->title : 'Добавить новый апартамент'}}
                        </h2>
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-add-service">
                                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                    <a data-toggle="tab" href="#nav-tour-content" aria-selected="true" class="active">{{__("1. Содержание")}}</a>
                                    <a data-toggle="tab" href="#nav-tour-location" aria-selected="false">{{__("2. Расположение")}}</a>
                                    <a data-toggle="tab" href="#nav-tour-pricing" aria-selected="false">{{__("3. Цена")}}</a>
                                    <a data-toggle="tab" href="#nav-availability" aria-selected="false">{{__("4. Доступность")}}</a>
                                ...
                                <div class="tab-content" id="nav-tabContent">
                                    <div class="tab-pane fade show active" id="nav-tour-content">
                                        ...
                                        <div class="form-group">
                                            <label>{{__("Избранное изображение")}}</label>
