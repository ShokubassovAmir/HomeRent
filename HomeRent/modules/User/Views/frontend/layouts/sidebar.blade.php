...
<div class="sidebar-user">
    ...
    <div class="logout">
        ...
        <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-sign-out"></i> {{__("Выйти")}}
        </a>
    </div>
    <div class="logout">
        <a href="{{url('/')}}"><i class="fa fa-long-arrow-left"></i> {{__("Вернуться на главную страницу")}}</a>
    </div>
</div>
