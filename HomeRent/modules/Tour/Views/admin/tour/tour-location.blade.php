<div class="panel">
    <div class="panel-title"><strong>{{__("Расположение апартамента")}}</strong></div>
    <div class="panel-body">
        <div class="form-group">
            <label class="control-label">{{__("Место расположения")}}</label>
            <div class="">
        ...
        <div class="form-group">
            <label class="control-label">{{__("Адрес")}}</label>
            <input type="text" name="address" class="form-control" placeholder="{{__("Адрес")}}" value="{{$row->address}}">
        </div>
        <div class="form-group">
