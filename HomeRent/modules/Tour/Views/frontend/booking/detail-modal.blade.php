        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#booking-detail-{{$booking->id}}">{{__("Детали бронирования")}}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#booking-customer-{{$booking->id}}">{{__("Ваша информация")}}</a>
                    </li>
                </ul>
                            ...
                            <div class="booking-review-content">
                                <div class="review-section">
                                    <div class="info-form">
                                        <ul>
                                            <li>
                                                <div class="label">{{__('Дата бронирования')}}</div>
                                            ...
                                            @if(!empty($booking->gateway))
                                                ...
                                                <li>
                                                    <div class="label">{{__('Способ оплаты')}}</div>
            ...
            <div class="modal-footer">
                <span class="btn btn-secondary" data-dismiss="modal">{{__("Закрыть")}}</span>
            </div>
        </div>
    </div>
</div>
