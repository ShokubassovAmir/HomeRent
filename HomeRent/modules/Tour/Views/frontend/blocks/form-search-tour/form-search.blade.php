    ...
    <div class="row">
        <div class="col-md-5 border-right">
            <div class="form-group field-detination">
                ...
                <div class="dropdown" id="dropdown-destination">
                    <label>{{__("Пункт назначения")}}</label>
                    <select name="location_id" class="form-control">
                        <option value="">{{__("Куда вы хотите поехать?")}}</option>
                        <?php
        ...
        <div class="col-md-2">
            <div class="g-button-submit">
                <button class="btn btn-primary btn-search" type="submit">{{__("Поиск")}}</button>
            </div>
        </div>
    </div>
</form>