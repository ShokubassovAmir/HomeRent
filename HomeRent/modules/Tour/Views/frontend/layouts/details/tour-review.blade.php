@if(setting_item("tour_enable_review"))
    <div class="bravo-reviews">
        <h2 class="title-review">{{__("Что гостям понравилось:")}}</h2>
                ...
                <form action="{{ url("/review") }}" class="needs-validation" novalidate method="post">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" required class="form-control" name="review_title" placeholder="{{__("Тема")}}">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-8">
                            <div class="form-group">
                                <textarea name="review_content" required class="form-control" placeholder="{{__("Текст сообщения")}}" minlength="10"></textarea>
                    ...
                    <div class="text-center">
                        ...
                        <input id="submit" type="submit" name="submit" class="btn" value="{{__("Оставить отзыв")}}">
                    </div>
                </form>
            </div>
        </div>
