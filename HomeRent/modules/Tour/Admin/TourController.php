    ...
    public function create(Request $request)
    {
        ...
        if (!empty($request->input())) {
            ...
            if ($row->save()) {
                ...
                $row->saveSEO($request);
                return redirect('admin/module/tour')->with('success', __('Апартамент создан!'));
            }
        } else {
            $row = new Tour();
            $row->fill([
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (!empty($request->input())) {
            ...
            if ($row->save()) {
                ...
                $row->saveMeta($request);
                $row->saveSEO($request);
                return redirect('admin/module/tour/edit/'.$id)->with('success', __('Апартамент обновлен!'));
            }
        }
        $data = [
            'row'            => $row,
