<?php if(setting_item("tour_enable_review")): ?>
    <div class="bravo-reviews">
        <h2 class="title-review"><?php echo e(__("Что гостям понравилось:")); ?></h2>
                ...
                <form action="<?php echo e(url("/review")); ?>" class="needs-validation" novalidate method="post">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="text" required class="form-control" name="review_title" placeholder="<?php echo e(__("Тема")); ?>">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-8">
                            <div class="form-group">
                                <textarea name="review_content" required class="form-control" placeholder="<?php echo e(__("Текст сообщения")); ?>" minlength="10"></textarea>
                    ...
                    <div class="text-center">
                        ...
                        <input id="submit" type="submit" name="submit" class="btn" value="<?php echo e(__("Оставить отзыв")); ?>">
                    </div>
                </form>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/booking8/modules/Tour/Views/frontend/layouts/details/tour-review.blade.php ENDPATH**/ ?>