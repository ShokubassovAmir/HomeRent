<div class="booking-review">
    <h4 class="booking-review-title"><?php echo e(__("Ваше бронирование")); ?></h4>
        ...
        <div class="review-section">
            <ul class="review-list">
                <?php if($booking->start_date): ?>
                    <li>
                        <div class="label"><?php echo e(__('Дата начала заезда:')); ?></div>
                        <div class="val">
        ...
        <div class="review-section total-review">
            <ul class="review-list">
                ...
                <li class="final-total">
                    <div class="label"><?php echo e(__("Итого:")); ?></div>
                    <div class="val"><?php echo e(format_money($booking->total)); ?></div>
                </li>
            </ul>
        </div>
    </div>
</div><?php /**PATH /opt/lampp/htdocs/booking8/modules/Tour/Views/frontend/booking/detail.blade.php ENDPATH**/ ?>