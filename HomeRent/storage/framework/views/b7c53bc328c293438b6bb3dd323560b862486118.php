<form class="form bravo-form-register" method="post">
    ...
    <div class="row">
        <div class="col-lg-6 col-md-12">
            <div class="form-group">
                <input type="text" class="form-control" name="first_name" autocomplete="off" placeholder="<?php echo e(__("Имя")); ?>">
        ...
        <div class="col-lg-6 col-md-12">
            <div class="form-group">
                <input type="text" class="form-control" name="last_name" autocomplete="off" placeholder="<?php echo e(__("Фамилия")); ?>">
                <i class="input-icon field-icon fa"><img src="<?php echo e(url('images/ico_fullname_signup.svg')); ?>"></i>
    ...
    <div class="form-group">
        <input type="email" class="form-control" name="email" autocomplete="off" placeholder="Почта *">
    ...
    <div class="form-group">
        <label for="term">
            ...
            <?php echo e(__("Регистрируясь, я принимаю Политику конфиденциальности и Условия предоставления услуг.")); ?>
    ...
    <div class="c-grey f14 text-center">
       <?php echo e(__(" Уже есть учетная запись?")); ?>

        <a href="#" data-target="#login" data-toggle="modal"><?php echo e(__("Войти в систему")); ?></a>
    </div>
</form><?php /**PATH /opt/lampp/htdocs/booking8/resources/views/auth/register-form.blade.php ENDPATH**/ ?>