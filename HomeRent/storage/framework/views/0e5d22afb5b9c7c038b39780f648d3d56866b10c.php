...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(__("Все апартаменты")); ?></h1>
            <div class="title-actions">
                <a href="<?php echo e(url('admin/module/tour/create')); ?>" class="btn btn-primary"><?php echo e(__("Добавить апартамент")); ?></a>
            </div>
        </div>
                ...
                <?php if(!empty($rows)): ?>
                    <form method="post" action="<?php echo e(url('admin/module/tour/bulkEdit')); ?>" class="filter-form filter-form-left d-flex justify-content-start">
                        ...
                        <select name="action" class="form-control">
                            ...
                            <option value="publish"><?php echo e(__(" Опубликовать ")); ?></option>
                            <option value="draft"><?php echo e(__(" Переместить в черновик ")); ?></option>
                            <option value="delete"><?php echo e(__(" Удалить ")); ?></option>
                        </select>
            ...
            <div class="col-left">
                <form method="get" action="<?php echo e(url('/admin/module/tour/')); ?> " class="filter-form filter-form-right d-flex justify-content-end flex-column flex-sm-row" role="search">
                    ...
                    <select name="cate_id" class="form-control">
                        <option value=""><?php echo e(__('--Все категории --')); ?> </option>
                        <?php
                    ...
                    <button class="btn-info btn btn-icon btn_search" type="submit"><?php echo e(__('Поиск')); ?></button>
                </form>
            </div>
        </div>
        <div class="panel">
                ...
                <form action="" class="bravo-form-item">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            ...
                            <th class="category"> <?php echo e(__('Категория')); ?></th>
                            <th class="author"> <?php echo e(__('Владелец')); ?></th>
                            <th width="100px"> <?php echo e(__('Статус')); ?></th>
                            <th width="100px"> <?php echo e(__('Отзывы')); ?></th>
                            <th class="date"> <?php echo e(__('Время')); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php if($rows->total() > 0): ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/booking8/modules/Tour/Views/admin/index.blade.php ENDPATH**/ ?>