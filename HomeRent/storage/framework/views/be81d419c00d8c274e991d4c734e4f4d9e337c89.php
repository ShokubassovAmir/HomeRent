<div class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            <label class="control-label"><?php echo e(__("Адрес")); ?></label>
            <input type="text" name="address" class="form-control" placeholder="<?php echo e(__("Адрес")); ?>" value="<?php echo e($row->address); ?>">
        </div>
        <div class="form-group">
...
</div><?php /**PATH /opt/lampp/htdocs/booking8/modules/Tour/Views/admin/tour/tour-location.blade.php ENDPATH**/ ?>