<div class="panel">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="">
                <textarea name="content" class="form_control" cols="70" rows="10"><?php echo e($row->content); ?></textarea>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="control-label"><?php echo e(__("Спальные места")); ?></label>
            <input type="text" name="bedPlaces" class="form-control" value="<?php echo e($row->bedPlaces); ?>" placeholder="<?php echo e(__("Спальные места")); ?>">
        </div>
        <div class="form-group">
            <label class="control-label"><?php echo e(__("Этаж/Количество этажей")); ?></label>
            <input type="text" name="floor" class="form-control" value="<?php echo e($row->floor); ?>" placeholder="<?php echo e(__("Этаж")); ?>">
        </div>
        <div class="form-group">
...
</div><?php /**PATH /opt/lampp/htdocs/booking8/modules/Tour/Views/admin/tour/tour-content.blade.php ENDPATH**/ ?>