                    ...
                    <?php else: ?>
                        <li class="login-item dropdown">
                            ...
                            <ul class="dropdown-menu text-left">
                                ...
                                <?php endif; ?>
                                <li class="menu-hr">
                                    <a  href="#" onclick="event.preventDefault(); document.getElementById('logout-form-topbar').submit();"><i class="fa fa-sign-out"></i> <?php echo e(__('Выйти')); ?></a>
                                </li>
                            </ul>
...
<?php /**PATH /opt/lampp/htdocs/booking8/resources/views/layouts/parts/topbar.blade.php ENDPATH**/ ?>