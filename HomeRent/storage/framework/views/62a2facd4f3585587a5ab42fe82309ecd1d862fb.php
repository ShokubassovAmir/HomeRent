...
$menus = [
    ...
    [
        ...
        'children'   => [
            ...
            [
                'url'        => '/user/apartment/create',
                'title'      => "Добавить апартамент",
...
<div class="sidebar-user">
    ...
    <div class="logout">
        ...
        <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-sign-out"></i> <?php echo e(__("Выйти")); ?>

        </a>
    </div>
    <div class="logout">
        <a href="<?php echo e(url('/')); ?>"><i class="fa fa-long-arrow-left"></i> <?php echo e(__("Вернуться на главную страницу")); ?></a>
    </div>
</div>
<?php /**PATH /opt/lampp/htdocs/booking8/modules/User/Views/frontend/layouts/sidebar.blade.php ENDPATH**/ ?>