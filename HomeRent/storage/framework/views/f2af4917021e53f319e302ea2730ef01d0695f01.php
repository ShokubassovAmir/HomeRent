        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#booking-detail-<?php echo e($booking->id); ?>"><?php echo e(__("Детали бронирования")); ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#booking-customer-<?php echo e($booking->id); ?>"><?php echo e(__("Ваша информация")); ?></a>
                    </li>
                </ul>
                            ...
                            <div class="booking-review-content">
                                <div class="review-section">
                                    <div class="info-form">
                                        <ul>
                                            <li>
                                                <div class="label"><?php echo e(__('Дата бронирования')); ?></div>
                                            ...
                                            <?php if(!empty($booking->gateway)): ?>
                                                ...
                                                <li>
                                                    <div class="label"><?php echo e(__('Способ оплаты')); ?></div>
            ...
            <div class="modal-footer">
                <span class="btn btn-secondary" data-dismiss="modal"><?php echo e(__("Закрыть")); ?></span>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /opt/lampp/htdocs/booking8/modules/Tour/Views/frontend/booking/detail-modal.blade.php ENDPATH**/ ?>