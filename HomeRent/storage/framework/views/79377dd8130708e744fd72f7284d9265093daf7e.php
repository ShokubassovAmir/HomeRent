<div class="article">
    ...
    <div class="space-between">
        ...
        <?php endif; ?>
        <div class="share" style="font-family:baltica; font-size:16px;" > <?php echo e(__("Поделиться")); ?>
...
<?php /**PATH /opt/lampp/htdocs/booking8/modules/News/Views/frontend/layouts/details/news-detail.blade.php ENDPATH**/ ?>