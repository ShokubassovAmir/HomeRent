                        ...
                        <table class="table table-hover">
                            ...
                            <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="title">
                                        <a href="<?php echo e(url('admin/module/tour/attribute/term_edit/'.$row->id)); ?>"><?php echo e($row->name); ?></a>
                                    </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/booking8/modules/Tour/Views/admin/terms/index.blade.php ENDPATH**/ ?>