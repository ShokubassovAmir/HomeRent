    ...
    <div class="post_item ">
        <div class="header">
            ...
            <div class="post-inner">
                ...
                <a class="btn-readmore" href="<?php echo e($row->getDetailUrl()); ?>"><?php echo e(__('Показать полностью...')); ?></a>
            </div>
        </div>
    </div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH /opt/lampp/htdocs/booking8/modules/News/Views/frontend/layouts/details/news-loop.blade.php ENDPATH**/ ?>