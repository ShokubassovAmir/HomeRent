...
<head>
    <meta charset="UTF-8"/>
    <title>Booking - Ultimate Booking System</title>
...
<!--<img src="<?php /*echo $url . '/img/footer-corrner.png'; */?>" class="footer-corrner"/>-->
    <div class="container">
        <h3>Creating your own Booking<br />System with <span>Booking</span> is super<br />fast and easy <img src="<?php echo e(url('landing/img/hand.svg')); ?>" /></h3>
        <a href="<?php echo e(config('landing.item_url')); ?>"
