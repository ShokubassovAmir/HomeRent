...
<head>
    ...
    <title><?php echo e($page_title ?? 'Dashboard'); ?> - <?php echo e(setting_item('site_title') ?? 'Booking'); ?></title>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 copy-right" >
                        <?php echo e(date('Y')); ?> &copy; Booking by <a href="https://www.bookingcore.org" target="_blank">BookingCore Team</a>
                    </div>
                    <div class="col-md-6">
...
<?php /**PATH D:\xampp\htdocs\booking8\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>