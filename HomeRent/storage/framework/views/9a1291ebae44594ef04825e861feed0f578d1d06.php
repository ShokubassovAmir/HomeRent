            ...
            <div class="row row-eq-height">
                ...
                <div class="col-md-9">
                    <div class="user-form-settings">
                        ...
                        <h2 class="title-bar">
                            <?php echo e(__("Управление апартаментами")); ?>

                            <?php if(Auth::user()->hasPermissionTo('tour_create')): ?>
                                <a href="<?php echo e(url("/user/apartment/create")); ?>" class="btn-change-password"><?php echo e(__("Добавить апартамент")); ?></a>
                            <?php endif; ?>
                        </h2>
                        ...
                        <?php else: ?>
                            <?php echo e(__("Апартаментов нет")); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/booking8/modules/User/Views/frontend/manageTour/index.blade.php ENDPATH**/ ?>