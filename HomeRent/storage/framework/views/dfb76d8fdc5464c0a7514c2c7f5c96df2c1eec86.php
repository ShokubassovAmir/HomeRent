    ...
    <div class="row">
        <div class="col-md-5 border-right">
            <div class="form-group field-detination">
                ...
                <div class="dropdown" id="dropdown-destination">
                    <label><?php echo e(__("Пункт назначения")); ?></label>
                    <select name="location_id" class="form-control">
                        <option value=""><?php echo e(__("Куда вы хотите поехать?")); ?></option>
                        <?php
            ...
            <div class="form-group form-date-field form-date-search clearfix  has-icon" data-format="DD/MM/YYYY">
                ...
                <div class="date-wrapper clearfix">
                    <div class="check-in-wrapper">
                        <label><?php echo e(__("Заезд - Отъезд")); ?></label>
        ...
        <div class="col-md-2">
            <div class="g-button-submit">
                <button class="btn btn-primary btn-search" type="submit"><?php echo e(__("Поиск")); ?></button>
            </div>
        </div>
    </div>
</form><?php /**PATH /opt/lampp/htdocs/booking8/modules/Tour/Views/frontend/blocks/form-search-tour/form-search.blade.php ENDPATH**/ ?>