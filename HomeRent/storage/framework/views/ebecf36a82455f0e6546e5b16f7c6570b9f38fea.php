<form class="bravo-form-login" method="POST" action="<?php echo e(route('login')); ?>">
    ...
    <div class="form-group">
        <input type="text" class="form-control" name="email" autocomplete="off" placeholder="<?php echo e(__('Адрес электронной почты')); ?>">
        <i class="input-icon fa fa-envelope-o"></i>
        <span class="invalid-feedback error error-email"></span>
    </div>
    <div class="form-group">
        <input type="password" class="form-control" name="password" autocomplete="off"  placeholder="<?php echo e(__('Пароль')); ?>">
    ...
    <div class="form-group">
        <div class="d-flex justify-content-between">
            <label for="remember-me" class="mb0">
                <input type="checkbox" name="remember" id="remember-me" value="1"> <?php echo e(__('Запомнить')); ?> <span class="checkmark fcheckbox"></span>
            </label>
            <a href="<?php echo e(url("/password/reset")); ?>"><?php echo e(__('Забыли пароль?')); ?></a>
        </div>
    </div>
    ...
    <?php endif; ?>
    <div class="c-grey font-medium f14 text-center"> <?php echo e(__('Впервые пользуетесь HomeRent?')); ?> <a href="" data-target="#register" data-toggle="modal"><?php echo e(__('Зарегистрироваться')); ?></a>
    </div>
</form><?php /**PATH /opt/lampp/htdocs/booking8/resources/views/auth/login-form.blade.php ENDPATH**/ ?>