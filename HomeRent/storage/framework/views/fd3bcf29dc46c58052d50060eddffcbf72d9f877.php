            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="form-controls">
                        <input type="text" class="form-control" name="site_title" value="<?php echo e($settings['site_title'] ?? 'Booking'); ?>">
                    </div>
                </div>
                <div class="form-group">
...
<?php /**PATH /opt/lampp/htdocs/booking8/modules/Core/Views/admin/settings/groups/general.blade.php ENDPATH**/ ?>