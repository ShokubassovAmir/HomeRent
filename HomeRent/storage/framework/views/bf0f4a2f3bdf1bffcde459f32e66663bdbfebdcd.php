                ...
                options: {
                    ...
                    scales: {
                        xAxes: [{
                            ...
                            scaleLabel: {
                                display: true,
                                labelString: '<?php echo e(__("График")); ?>'
                            }
                        }],
                        yAxes: [{
                            display: true,
                            scaleLabel: {
                                display: true,
                                labelString: '<?php echo e(__("Употребительность: :currency_main",['currency_main'=>setting_item('currency_main')])); ?>'
                            }
                        }]
                    },
                    tooltips: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/booking8/modules/Report/Views/admin/statistic/index.blade.php ENDPATH**/ ?>