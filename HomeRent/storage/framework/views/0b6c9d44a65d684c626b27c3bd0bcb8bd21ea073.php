...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(__("Календарь бронирования апартаментов")); ?></h1>
        </div>
        ...
        <div class="booking-calendar vec-wrap panel" id="booking-calendar" >
            <div class="panel-body">
                <div class="vec-header-toolbar d-flex justify-content-between align-items-center">
                    <div class=""><i><span class="count-string"></span></i></div>
                ...
                <table class="vec-view-container" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <th width="300px" class="vec-event-header"><?php echo e(__('Апартаменты')); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/booking8/modules/Tour/Views/admin/booking/index.blade.php ENDPATH**/ ?>