<div class="b-panel-title"><?php echo e(__('Информация о бронировании')); ?></div>
<div class="b-table-wrap">
    <table class="b-table" cellspacing="0" cellpadding="0">
        <tr>
            <td class="label"><?php echo e(__('Номер заказа')); ?></td>
            <td class="val">#<?php echo e($booking->id); ?></td>
        </tr>
        <tr>
            <td class="label"><?php echo e(__('Статус бронирования')); ?></td>
            <td class="val"><?php echo e($booking->statusName); ?></td>
        </tr>
        <?php if($booking->gatewayObj): ?>
            <tr>
                <td class="label"><?php echo e(__('Способ оплаты')); ?></td>
                <td class="val"><?php echo e($booking->gatewayObj->getOption('name')); ?></td>
            </tr>
        <?php endif; ?>
        <tr>
            <td class="label"><?php echo e(__('Название апартамента')); ?></td>
            <td class="val">
        ...
        <tr>
            <?php if($service->address): ?>
                <td class="label"><?php echo e(__('Локация')); ?></td>
                <td class="val">
        ...
        <?php if($booking->start_date && $booking->end_date): ?>
            <tr>
                <td class="label"><?php echo e(__('Дата начала')); ?></td>
        ...
        <?php endif; ?>
        <tr>
            <td class="label"><?php echo e(__('Цена')); ?></td>
        ...
        <tr>
            <td class="label fsz21"><?php echo e(__('Итого')); ?></td>
            <td class="val fsz21"><strong style="color: #FA5636"><?php echo e(format_money($booking->total)); ?></strong></td>
        </tr>
    </table>
</div>
<div class="text-center mt20">
    <a href="<?php echo e(url('user/booking-history')); ?>" target="_blank" class="btn btn-primary"><?php echo e(__('Управление бронированием')); ?></a>
</div>
<?php /**PATH /opt/lampp/htdocs/booking8/modules/Tour/Views/emails/new_booking_detail.blade.php ENDPATH**/ ?>